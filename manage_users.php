...
<div class="container" style="margin-top: 1rem;">
    ...
    <div class="users-table-container" style="background: var(--card-bg); border-radius: 1rem; border: 1px solid var(--border-color); overflow-x: auto; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
