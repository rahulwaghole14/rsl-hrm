...
<div class="container-fluid"
    style="padding: 0; display: flex; flex-direction: column; height: calc(100vh - 70px); background: #f1f3f4; overflow: hidden;">
    <!-- Spreadsheet Header Area -->
    <div
        style="background: white; padding: 0.75rem 1.5rem; border-bottom: 1px solid #e0e0e0; display: flex; justify-content: space-between; align-items: center; flex-shrink: 0;">
